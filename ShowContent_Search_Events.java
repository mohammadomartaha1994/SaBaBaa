...
public class ShowContent_Search_Events extends AppCompatActivity {
    ArrayList<AdapterItems> listnewsData = new ArrayList<AdapterItems>();
    ShowContent_Search_Events.MyCustomAdapter myadapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.show_content__search__events);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        myadapter=new ShowContent_Search_Events.MyCustomAdapter(listnewsData);
        ...
        new ShowContent_Search_Events.MyAsyncTaskgetNews().execute(url);
    ...
    private class MyCustomAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Picasso.with(ShowContent_Search_Events.this).load(s.image).into(image);
            ...
            image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final AlertDialog alertD = new AlertDialog.Builder(ShowContent_Search_Events.this).create();

                    ImageView imageView = (ImageView) promptView.findViewById(R.id.image);
                    Picasso.with(ShowContent_Search_Events.this).load(s.image).into(imageView);
...
//            });
    ...
    public class MyAsyncTaskgetNews extends AsyncTask<String, String, String> {
        final ProgressBuilder loading=new ProgressBuilder(ShowContent_Search_Events.this);
        @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if(id == android.R.id.home){
            Intent intent = new Intent(this,ShowContent_Search.class);
